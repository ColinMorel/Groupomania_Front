        ...
        <ProfilePage>
            ...
            <ProfileCard >
                    <ProfileLeftPart>
                        ...
                        <br/>
                        <label  style={{padding:'5px'}}htmlFor='avatar' alt="avatar">Avatar</label><br/>
                        <ProfileInputFile id="avatar" type="file" alt="image" accept="image/jpg,image/jpeg,image/png"/>
                    ...
                    <ProfileRightPart>
                        ...
                        <label style={{paddingTop:'20%',color:'black'}} htmlFor='bio'>Bio</label>
